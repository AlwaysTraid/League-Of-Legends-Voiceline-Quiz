...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener{
    ...
    private var mQuestionsList:ArrayList<Voiceline>? = null
    ...
    private fun setQuestion(){
        ...
        tv_voiceline.text = question.voiceline
    ...
    private fun selectedOptionView(tv: TextView, selectedObjectNum: Int){

        if(!questionAnswered) {
            defaultOptionsView()
            mSelectedOptionPosition = selectedObjectNum
